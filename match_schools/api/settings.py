...
def _student_open_messaging() -> bool:
	from match_schools.api.messaging import student_open_messaging
...
PREFERENCE_KEYS = {
	"ms_pref_language": "language",
	"ms_pref_theme": "theme",
	"ms_pref_notify_email": "notify_email",
	"ms_pref_notify_announcements": "notify_announcements",
	"ms_pref_notify_grades": "notify_grades",
	"ms_pref_notify_attendance": "notify_attendance",
	"ms_pref_density": "density",
}
