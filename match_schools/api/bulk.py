...
OWNED_BY_INSTRUCTOR = {"MS Assignment": "instructor"}
...
BULK_RULES: dict[str, dict] = {
	...
	"MS Library Book": {"delete": list(BACK_OFFICE), "set": {}},
	"MS Book Loan": {
		"delete": list(BACK_OFFICE),
		"set": {"status": list(BACK_OFFICE)},
	},
	"MS Behaviour Record": {"delete": [ROLE_ADMIN, ROLE_SECRETARY, ROLE_TEACHER], "set": {}},
