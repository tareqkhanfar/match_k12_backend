...
OPEN_MESSAGING_KEY = "k12_student_open_messaging"
...
def _instructor_user(instructor: str) -> str | None:
	from match_k12.api.communication import _instructor_user as resolve
...
def allowed_recipients(persona: str, scope: dict) -> set[str] | None:
	...
	from match_k12.api.communication import _back_office_users
...
def audience(search: str = None, persona: str = None):
	...
	from match_k12.api.communication import contacts as contact_list
...
def send(
	...
	from match_k12.api.assignments import _normalise_files
	from match_k12.api.communication import _as_html
...
def conversation(thread: str, persona: str = None):
	...
	for f in frappe.get_all(
		"K12 Attachment",
		filters={"parent": ["in", [r.name for r in rows]], "parenttype": "K12 Message"},
