...
MATRIX: dict[str, dict[str, dict]] = {
	...
	"K12 Survey": {ADMIN: FULL, SECRETARY: FULL, TEACHER: READ, STUDENT: READ, PARENT: READ},
	"K12 Survey Question": {ADMIN: FULL, SECRETARY: FULL, TEACHER: READ, STUDENT: READ, PARENT: READ},
	"K12 Survey Response": {
	...
	"K12 Resource": {ADMIN: FULL, SECRETARY: FULL, TEACHER: WRITE, STUDENT: READ, PARENT: READ},
	"K12 Alert Rule": {ADMIN: FULL, SECRETARY: FULL},
	"K12 Alert Action": {ADMIN: FULL, SECRETARY: FULL},
	"K12 Student Alert": {
		ADMIN: FULL, SECRETARY: FULL, TEACHER: READ, STUDENT: WRITE, PARENT: WRITE,
	},
	"K12 Quiz": {ADMIN: FULL, SECRETARY: FULL, TEACHER: WRITE, STUDENT: READ, PARENT: READ},
	"K12 Quiz Question": {ADMIN: FULL, SECRETARY: FULL, TEACHER: WRITE, STUDENT: READ},
	"K12 Quiz Attempt": {ADMIN: FULL, SECRETARY: FULL, TEACHER: WRITE, STUDENT: WRITE, PARENT: READ},
	"K12 Quiz Answer": {ADMIN: FULL, SECRETARY: FULL, TEACHER: WRITE, STUDENT: WRITE, PARENT: READ},
	...
	"K12 Timetable Plan": {ADMIN: FULL, SECRETARY: FULL, TEACHER: READ},
	"K12 Timetable Period": {ADMIN: FULL, SECRETARY: FULL, TEACHER: READ},
	"K12 Subject Load": {ADMIN: FULL, SECRETARY: FULL, TEACHER: READ},
	"K12 Term Submission": {
